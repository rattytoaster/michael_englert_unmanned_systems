...
def Astar(min_x, max_x, min_y, max_y, 
    ...
    current_node = Node(start_x, start_y, 0 + compute_distance(start_x, start_y, goal_x, goal_y), int(-1), 0)
    ...
    while [current_node.x, current_node.y] != [goal_x, goal_y]:
        ...
        for move in filtered_moves:
            ...
            # from + to new_node
            djikstras_cost = current_node.djikstras + compute_distance(move[0],move[1], current_node.x, current_node.y)
            new_cost = current_node.djikstras + compute_distance(move[0],move[1], current_node.x, current_node.y) + compute_distance(move[0], move[1],goal_x, goal_y)
                        
            # new_djikstras = current_node.cost \
            ...
            # - if inside unvisited:        
                ...
                if new_cost < unvisited[new_index].cost:
                    ...
                    unvisited[new_index].djikstras = djikstras_cost
            ...
            new_node = Node(move[0], move[1], new_cost, current_idx, djikstras_cost)
    ...
    for i in range(lengt):
        ...
        path.append((path_x[(lengt-1-i)],path_y[(lengt-1-i)]))
